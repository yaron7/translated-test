...
export const getUsersInGroup = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const getGroupsForUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
